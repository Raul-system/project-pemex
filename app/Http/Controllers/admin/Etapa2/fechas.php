...
class fechas extends Controller
{
    ...
    public function index()
    {
        ...
        $integrantes_proceso = Integracion::paginate(15);
    ...
    public function show($id)
    {
        ...
        return view('pages.etapa2.fechas-candidato', compact('proceso_integracionRegional', 'proceso_desarrolloHumano', 'proceso_departamentoPersonal'));
    }
