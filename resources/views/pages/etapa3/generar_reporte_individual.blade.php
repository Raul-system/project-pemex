<table>
    ...
    <tbody>
        <tr>
            ...
            <td style="text-align: center;"><b>Integracion Regional: </b>{{$candidato_contratado->area_integracion_valida}} <br>  <b>Desarrollo Humano: </b>{{$candidato_contratado->dh_valida}}</td>
        </tr>
    </tbody>
</table>