<table>
    <thead>
    <tr>
            <th style="background-color: black; color: white; width: 10px; text-align: center;">ID</th>
            ...
            <th style="background-color: black; color: white; width: 35px; text-align: center;">profesion</th>
    ...
    <tbody>
        <tr>
            <td style="text-align: center;">{{$candidato_contratado->id}}</td>
